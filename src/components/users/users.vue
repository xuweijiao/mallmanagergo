...
<div>
    <el-card>
        ...
        <div style="margin-top: 15px;">
            <el-input @clear="searchUser()" clearable placeholder="请输入内容" v-model="query" class="input-with-select" style="width:300px">
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column header-align="center" align="center" prop="username" label="姓名" width="100"></el-table-column>
            ...
            <el-table-column header-align="center" prop align="center" label="操作">
                <template slot-scope="scope">
                    <el-row>
                        ...
                        <el-button @click="showUserRole(scope.row)" size="mini" plain type="success" icon="el-icon-check" circle></el-button>
                    </el-row>
                </template>
            </el-table-column>
        </el-table>
        <!-- 分页 -->
        <div class="block">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="pagenum" :page-sizes="[4, 6]" :pagesize="pagesize" layout="total, sizes, prev, pager, next, jumper" :total="total"></el-pagination>
        </div>
    </el-card>
